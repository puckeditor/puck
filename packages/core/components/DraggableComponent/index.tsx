...
import { useDragHandle } from "../../lib/dnd/drag-handle";
...
export const DraggableComponent = ({
  ...
  const draggingFromHandle = useContextStore(
    ZoneStoreContext,
    (s) => s.draggingFromHandle && s.draggedItem?.id === id
  );

  const { handleRef, assignHandleRef, overlayRef } =
  ...
  return (
    <DropZoneProvider value={nextContextValue}>
      {/* Keep the action bar mounted during handle drags. */}
      {((dragFinished && isVisible) || draggingFromHandle) &&
        createPortal(
          <div
            className={getClassName({
              isSelected: isSelected || draggingFromHandle,
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                pointerEvents: draggingFromHandle ? "none" : undefined,
              }}
            >
              <div
