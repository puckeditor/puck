...
export type MountedInstance = {
  /** Reconcile the mount toward the next props/context (component: a `Split`; field: a props object). */
  patch: (next: any) => void;
 ...
 * component/field and reconcile it, how to mint slot outlets (optional — Svelte
 * uses context instead), and how outlets are threaded into props (optional).
 */
export type FrameworkAdapter = {
  mountComponent: (args: ComponentMountArgs) => MountedInstance;
  mountField: (args: FieldMountArgs) => MountedInstance;
  /**
