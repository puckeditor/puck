...
| `--puck-button-secondary-color-disabled-bg`   | `var(--puck-button-default-color-disabled-bg)`   |
| `--puck-button-secondary-color-disabled-text` | `var(--puck-button-default-color-disabled-text)` |
