...
| `--puck-field-color-disabled-bg`     | `var(--puck-color-surface-muted)`                              | Disabled background               |
| `--puck-field-color-disabled-border` | `var(--puck-color-border)`                                     | Disabled border color             |
| `--puck-field-color-disabled-text`   | `var(--puck-color-text-secondary)`                             | Disabled text color               |
...
| `--puck-field-label-color`           | `var(--puck-color-text-secondary)`                             | Label text color                  |
...
| `--puck-field-label-icon-color`      | `var(--puck-color-text-subtle)`                                | Label icon color                  |

### Array

| Token                               | Default                         | Description           |
| ----------------------------------- | ------------------------------- | --------------------- |
| `--puck-field-array-add-icon-color` | `var(--puck-color-interactive)` | Add button icon color |
