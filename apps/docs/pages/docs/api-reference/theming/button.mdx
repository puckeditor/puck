...
| `--puck-button-primary-color-disabled-bg`   | `var(--puck-color-disabled-bg)`        | Disabled background    |
| `--puck-button-primary-color-disabled-text` | `var(--puck-color-disabled-text)`      | Disabled text color    |
...
| `--puck-button-secondary-color-disabled-bg`   | `var(--puck-color-disabled-bg)`      | Disabled background    |
| `--puck-button-secondary-color-disabled-text` | `var(--puck-color-disabled-text)`    | Disabled text color    |
