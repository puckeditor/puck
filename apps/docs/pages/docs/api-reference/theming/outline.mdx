...
| `--puck-outline-color-drop-indicator`  | `var(--puck-color-interactive-active)` | Drag-and-drop line indicator color    |
...
| `--puck-outline-icon-size`             | `var(--puck-icon-size-s)`              | Layer and zone icon size              |
| `--puck-outline-action-size`           | `var(--puck-icon-size-xs)`             | Expand caret and row action icon size |
