...
| ------------------------------------------ | ---------------------- |
| `--puck-action-bar-color-bg`               | `#181818`              |
| `--puck-action-bar-color-text`             | `#ffffff`              |
| `--puck-action-bar-color-text-opacity`     | `0.75`                 |
| `--puck-action-bar-color-separator`        | `#767676`              |
| `--puck-action-bar-color-hover`            | `#6499cf`              |
| `--puck-action-bar-color-active`           | `#88b0da`              |
| `--puck-action-bar-color-disabled`         | `#ffffff`              |
| `--puck-action-bar-color-disabled-opacity` | `0.54`                 |
| `--puck-action-bar-space-y`                | `4px`                  |
| `--puck-action-bar-space-x`                | `0`                    |
| `--puck-action-bar-radius`                 | `8px`                  |
| `--puck-action-bar-font-size`              | `0.75rem` (`12px`)     |
| `--puck-action-bar-action-space`           | `6px`                  |
| `--puck-action-bar-action-size`            | `16px`                 |
...
| `--puck-button-primary-color-disabled-bg`     | `#ababab`                   |
| `--puck-button-primary-color-disabled-text`   | `#404040`                   |
...
| `--puck-button-secondary-color-disabled-bg`   | `#ababab`                   |
| `--puck-button-secondary-color-disabled-text` | `#404040`                   |
...
| `--puck-field-color-disabled-bg`             | `#f5f5f5`                   |
| `--puck-field-color-disabled-border`         | `#dcdcdc`                   |
| `--puck-field-color-disabled-text`           | `#5a5a5a`                   |
...
| Token                                    | Computed default value |
| ---------------------------------------- | ---------------------- |
| `--puck-icon-button-radius`              | `4px`                  |
| `--puck-icon-button-space`               | `4px`                  |
| `--puck-icon-button-color-bg`            | `transparent`          |
| `--puck-icon-button-color-bg-hover`      | `#efefef`              |
| `--puck-icon-button-color-bg-active`     | `#f3f6fb`              |
| `--puck-icon-button-color-icon`          | `currentColor`         |
| `--puck-icon-button-color-icon-hover`    | `#0158ad`              |
| `--puck-icon-button-color-icon-active`   | `#0158ad`              |
| `--puck-icon-button-color-icon-disabled` | `#ababab`              |
