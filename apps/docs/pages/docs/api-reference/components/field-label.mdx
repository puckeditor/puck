...
```tsx showLineNumbers copy {1,4-6}
...
```tsx showLineNumbers copy /label="Title"/
import { FieldLabel } from "@measured/puck";
...
```tsx showLineNumbers copy /className="MyClass"/
import { FieldLabel } from "@measured/puck";
...
```tsx showLineNumbers copy /el="div"/
import { FieldLabel } from "@measured/puck";
...
```tsx showLineNumbers copy /icon={<Globe size="16" />}/
import { FieldLabel } from "@measured/puck";
import { Globe } from "lucide-react";
...
```tsx showLineNumbers copy /readOnly/1
import { FieldLabel } from "@measured/puck";
