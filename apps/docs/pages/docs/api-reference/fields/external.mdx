...
```tsx showLineNumbers copy {13-17}
const config = {
  components: {
    Example: {
      fields: {
...
```tsx showLineNumbers copy {18-20}
const config = {
  components: {
    Example: {
      fields: {
...
```tsx showLineNumbers copy {13-15}
const config = {
  components: {
    Example: {
      fields: {
