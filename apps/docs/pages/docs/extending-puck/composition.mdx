...
<Callout type="warning">
  The compositional editor components described here are currently part of the
  core React/Preact API. Native Vue and Svelte composition components are not
  yet available.
</Callout>
