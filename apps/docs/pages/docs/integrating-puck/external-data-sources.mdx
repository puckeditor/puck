...
You can also use the [`showSearch` parameter](/docs/api-reference/fields/external#showsearch), [`sortableColumns` parameter](/docs/api-reference/fields/external#sortablecolumns), and [`pagination` parameter](/docs/api-reference/fields/external#pagination) to customize the external data source.
...
```tsx showLineNumbers {18-36} /id: 0/1 /id: 1/ copy
const config = {
  components: {
    Example: {
      fields: {
