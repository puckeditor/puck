...
```tsx showLineNumbers copy {5-7,10}
const config = {
  components: {
    Example: {
      fields: {
...
```tsx showLineNumbers copy {5-10,17,18}
const config = {
  components: {
    Example: {
      fields: {
...
```tsx showLineNumbers copy {13-14,21,24-28}
const config = {
  components: {
    Example: {
      fields: {
...
```tsx showLineNumbers copy {2-6,12}
const config = {
  categories: {
    typography: {
      components: ["Card"],
