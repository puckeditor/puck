...
```tsx showLineNumbers copy filename="puck.config.tsx"
...
```tsx showLineNumbers copy filename="components/HeadingBlock.tsx" {1}
"use client";
...
```tsx showLineNumbers copy filename="app/page.tsx"
...
```tsx showLineNumbers copy filename="puck-types.ts"
import type { Config } from "@measured/puck";
...
```tsx showLineNumbers copy filename="puck.config.client.tsx"
...
```tsx showLineNumbers copy filename="puck.config.server.tsx"
import type { UserConfig } from "./puck-types.ts";
