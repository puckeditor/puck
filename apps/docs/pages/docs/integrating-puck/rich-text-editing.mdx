...
Puck supports rich text input via the [`richtext`](/docs/api-reference/fields/richtext) field.
...
<ConfigPreview
  ...
  componentConfig={{
    ...
    defaultProps: {
      richtext:
        "<p>Hello, <strong>world</strong></p><ul><li><p>List item 1</p></li><li><p>List item 2</p></li><li><p>List item 3</p></li></ul>",
    },
    render: ({ richtext }) => {
      return richtext;
    },
...
<ConfigPreview
  ...
  componentConfig={{
    ...
    defaultProps: {
      richtext:
        "<p>Edit me <strong>inline:</strong></p><ul><li><p>List item 1</p></li><li><p>List item 2</p></li><li><p>List item 3</p></li></ul>",
    },
    render: ({ richtext }) => {
      return richtext;
    },
...
The rich text field is built with [Tiptap](https://tiptap.dev), and comes with [several Tiptap extensions](/docs/api-reference/fields/richtext#included-extensions) pre-configured.
...
```tsx copy showLineNumbers {2-3, 12-25}
import Superscript from "@tiptap/extension-superscript";
